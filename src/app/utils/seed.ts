...
export const seedSuperAdmin = async () => {
    try {
        ...
        if(!name || !email || !password){
            throw new Error("Super Admin name or email or password Missing in Env File!!");
        }
...
export const seedTesterAdmin = async () => {
    try {
        ...
        if(!name || !email || !password){
            throw new Error("Tester Admin name or email or password Missing in Env File!!");
        }
...
export const seedTesterDoctor = async () => {
    try {
        ...
        if(!name || !email || !password){
            throw new Error("Tester Doctor name or email or password Missing in Env File!!");
        }
